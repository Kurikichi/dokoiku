$(document).on('turbolinks:load', function(){
    ...
    aryQuiz.push(
        {
            question : 'Q1. 今日の気分は？',
            answer : ['のんびり', 'そこそこ', 'ノリノリ', 'アクティブ']
        }
        ,{
            question : 'Q2. 誰と行きますか？',
            answer : ['一人で', '友人と', '恋人と', '家族で']
        }
        ,{
            question : 'Q3. 交通手段は？',
            answer : ['徒歩・自転車', '自動車', '電車・バス', '飛行機']
        }
        ,{
            question : 'Q4. 何日の予定ですか？',
            answer : ['日帰り', '一泊二日', '二泊三日', '三泊四日以上']
        }
        ,{
            question : 'Q5. 予算は？',
            answer : ['〜1000円', '〜5000円', '〜10000円', 'プライスレス！']
        }
    );
    ...
    function quizShow(){
        ...
        var aryHoge = (aryQuiz[quiz_cnt]['answer'].concat());
        //問題文の配列を繰り返し表示する
    ...
    function quizResult(){
        ...
        var text = 'あなたへのオススメは『東京ディズニーランド』です！';
        // if(quiz_fin_cnt === quiz_success_cnt){
        //     text += 'あなたへのオススメは東京ディズニーランドです！';
        // }
        text += '<br><input type="button" value="カレンダーに追加する！" onclick="history.back()" class="add_cals">';
